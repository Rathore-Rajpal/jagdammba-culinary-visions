...
const MenuPage = () => {
  ...
  const menuItems = [
    ...
    { name: "Lapsi", hindiName: "लपसी", category: "sweets", description: "Traditional sweet made from broken wheat", image: sweetsCollection },
    ...
    { name: "Anjir Katli", hindiName: "अंजीर कटली", category: "sweets", description: "Fig-based sweet delicacy", image: sweetsCollection },
    ...
    { name: "Bundi", hindiName: "बूंदी", category: "sweets", description: "Small sweet pearls made from gram flour", image: sweetsCollection },
    ...
    { name: "Guniya", hindiName: "गुझिया", category: "sweets", description: "Sweet stuffed pastry", image: sweetsCollection },
    ...
    { name: "Surma Laddu", hindiName: "सुरमा लड्डू", category: "sweets", description: "Special variety of laddu", image: sweetsCollection },
    ...
    { name: "Sponge Rasgulla", hindiName: "स्पंज रसगुल्ला", category: "sweets", description: "Soft spongy cheese balls in syrup", image: sweetsCollection },
    { name: "Kesar Rajbhog", hindiName: "केसर राजभोग", category: "sweets", description: "Saffron flavored rajbhog", image: sweetsCollection },
    { name: "Malai Rajbhog", hindiName: "मलाई राजभोग", category: "sweets", description: "Cream-filled rajbhog", image: sweetsCollection },
    { name: "Chamcham", hindiName: "छमछम", category: "sweets", description: "Bengali sweet delicacy", image: sweetsCollection },
    { name: "Kesar Chamcham", hindiName: "केसर छमछम", category: "sweets", description: "Saffron chamcham", image: sweetsCollection },
    { name: "Ras Malai", hindiName: "रसमलाई", category: "sweets", description: "Soft cheese patties in sweet milk", image: sweetsCollection },
    ...
    { name: "Chhena Roll", hindiName: "छेना रोल", category: "sweets", description: "Cottage cheese rolls", image: sweetsCollection },
    { name: "Chhena Toast", hindiName: "छेना टोस्ट", category: "sweets", description: "Grilled cottage cheese sweet", image: sweetsCollection },
    { name: "Khushbani", hindiName: "खुशबानी", category: "sweets", description: "Sweet apricot preparation", image: sweetsCollection },
    { name: "Kheer Chamcham", hindiName: "खीर छमछम", category: "sweets", description: "Kheer-filled chamcham", image: sweetsCollection },
    { name: "Kesar Bati", hindiName: "केसर बाटी", category: "sweets", description: "Saffron bati", image: sweetsCollection },
    ...
    { name: "Gulkand Barfi", hindiName: "गुलकंद बर्फी", category: "sweets", description: "Rose petal barfi", image: sweetsCollection },
    { name: "Sangam Dryfruit", hindiName: "संगम ड्राईफ्रूट", category: "sweets", description: "Mixed dry fruit sweet", image: sweetsCollection },
    { name: "Anjir Patasha", hindiName: "अंजीर पटाशा", category: "sweets", description: "Fig-based patasha", image: sweetsCollection },
    ...
    { name: "Gur Pak", hindiName: "गुड़ पाक", category: "sweets", description: "Jaggery-based sweet", image: sweetsCollection },
    ...
    { name: "Govind Gatta", hindiName: "गोविंद गट्टा", category: "vegetables", description: "Gram flour dumplings", image: curryDishes },
    ...
    { name: "Bhindi Shimla Mirchi Fry", hindiName: "भिंडी शिमला मिर्च फ्राई", category: "vegetables", description: "Okra and bell pepper fry", image: curryDishes },
    ...
    { name: "Mewa Moyer", hindiName: "मेवा मोयेर", category: "vegetables", description: "Dry fruit preparation", image: curryDishes },
    { name: "Kaju Kari Sabji", hindiName: "काजू करी सब्जी", category: "vegetables", description: "Cashew curry", image: curryDishes },
    { name: "Pankaj Kutta Sabji", hindiName: "पंकज कुट्टा सब्जी", category: "vegetables", description: "Special vegetable preparation", image: curryDishes },
    { name: "Gajar Muli Achar", hindiName: "गाजर मूली अचार", category: "vegetables", description: "Carrot radish pickle", image: curryDishes },
    { name: "Mirchi Kuta", hindiName: "मिर्ची कूटा", category: "vegetables", description: "Crushed chili preparation", image: curryDishes },
    { name: "Keri Gunda", hindiName: "केरी गुंदा", category: "vegetables", description: "Mango gunda preparation", image: curryDishes },
    { name: "Dal Fry", hindiName: "दाल फ्राई", category: "vegetables", description: "Fried lentils", image: curryDishes },
    { name: "Dal Makhani", hindiName: "दाल मखनी", category: "vegetables", description: "Creamy black lentils", image: curryDishes },
