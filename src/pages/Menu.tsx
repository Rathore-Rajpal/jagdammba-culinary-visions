...
const MenuPage = () => {
  ...
  const menuItems = [
    ...
    { name: "Mewa Moyer", hindiName: "मेवा मोयर", category: "vegetables", description: "Dry fruit preparation", image: curryDishes },
  ...
  { name: "Vegetable Raita", hindiName: "वेजीटेबल रायता", category: "vegetables", description: "Mixed vegetable yogurt", image: curryDishes },
    ...
    { name: "Mewa Moyer", hindiName: "मेवा मोयर", category: "snacks", description: "Dry fruit based snack", image: snacksImage },
    ...
    { name: "Moyan Kachori", hindiName: "मोयन कचोरी", category: "breakfast", description: "Stuffed fried pastry", image: curryDishes },
